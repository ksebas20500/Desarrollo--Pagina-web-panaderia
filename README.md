<div align="center">
  <img src="fronthend/imagen/logo.png" alt="Logo La Fábrica" width="150"/>
  <h1>🥖 La Fábrica - Panadería Artesanal</h1>
  <p><strong>El arte de hornear con pasión. Un sistema web completo para la gestión y venta de productos artesanales.</strong></p>
...
- 🏢 **Sistema Multi-Sucursal (Novedad)**: Posibilidad de asignar disponibilidad de inventario individual por producto. El sistema de la tienda oculta automáticamente aquel número de teléfono correspondientes a las sedes donde el producto haya marcado 'Sin Stock'.
...
- ⚡ **Rendimiento Optimizad**: Backend programado para evitar trasiegos masivos de bytes; ahora responde rápidamente acudiendo a búsquedas filtradas en SQL antes de emitir respuesta.
---
